        ...
        <div className="animate-fade-in space-y-6 mt-4">
          ...
          <div className="bg-card rounded-lg p-5 shadow-card border border-border space-y-3">
            ...
            <div className="h-3 rounded-pill bg-muted overflow-hidden">
              <div className="h-full rounded-pill bg-gradient-to-r from-primary to-secondary transition-all duration-500" style={{ width: `${progress}%` }} />
            </div>
          </div>

          <div className="bg-card rounded-lg p-5 shadow-card border border-border space-y-3">
            <span className="text-xs font-heading font-semibold bg-accent text-accent-foreground px-3 py-1 rounded-pill">In Progress</span>
            ...
            <Button size="full" onClick={() => navigate("/course")}>Continue Learning</Button>
          </div>

          <div className="flex gap-3">
            <Button variant="outline" className="flex-1" onClick={() => navigate("/recommendations")}>Path</Button>
            <Button variant="outline" className="flex-1" onClick={() => navigate("/progress")}>Progress</Button>
          </div>
        </div>
      </div>
    </div>
