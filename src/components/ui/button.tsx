  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-pill text-sm font-semibold font-heading ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-card text-base",
        pill: "bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground",
        "pill-active": "bg-primary text-primary-foreground shadow-soft",
      },
      size: {
        ...
        icon: "h-10 w-10",
        full: "h-14 px-6 w-full text-base",
      },
    },
    defaultVariants: {
      variant: "default",
